...
from ri_cloud_services.sumo_access.sumo_blob_access import (
    get_sas_token_and_blob_base_uri_for_object_id_async,
)
...
async def get_sas_token_and_blob_base_uri_for_blob_id_async(
    ...
    sas_token, blob_store_base_uri = await get_sas_token_and_blob_base_uri_for_object_id_async(
        sumo_client, object_id=blob_id
    )
